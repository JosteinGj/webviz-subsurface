...
folder, to avoid risk of not extracting the right data."""
    ...
    def tour_steps(self):
        steps = [
            ...
            },
            {
                ...
                "content": (
                    "Lets you control what parameters to include in your model. \n"
            ...
            },
            {
                ...
                "content": ("Plot showing the values of all the selected parameter at once."),
            },
    ...
    def set_callbacks(self, app):
        ...
        def _update_paralell_coordinate_plot(exc_inc, parameter_list, ensemble, response, *filters):
            ...
            data = [
                {
                    ...
                    "line": {
                        ...
                        "colorscale": colmap,
                        "showscale": True,
                        "colorbar": {"title": response, "xanchor": "left", "x": -0.08,},
                    },
                    "dimensions": dims,
                    "labelangle": 45,
                    "labelside": "bottom",
